...
public class EmbeddedServiceDefsUtil {
	...
	public static final String DEFAULT_BOOTSTRAP_SERVICEDEF_LIST = "tag,hdfs,hbase,hive,kms,knox,storm,yarn,kafka,solr,atlas,nifi,nifi-registry,sqoop,kylin,elasticsearch,presto,trino,ozone,kudu,schema-registry,openmetadata";
	...
	public static final String EMBEDDED_SERVICEDEF_OPENMETADATA_NAME = "openmetadata";
	...
	public static final String OPENMETADATA_IMP_CLASS_NAME = "org.apache.ranger.services.openmetadata.RangerServiceOpenmetadata";
	...
	private RangerServiceDef openmetadataServiceDef;
	...
	public void init(ServiceStore store) {
		...
		try {
			...
			openmetadataServiceDef = getOrCreateServiceDef(store, EMBEDDED_SERVICEDEF_OPENMETADATA_NAME);
	...
	public long getOpenmetadataServiceDefId() { return getId(openmetadataServiceDef); }
